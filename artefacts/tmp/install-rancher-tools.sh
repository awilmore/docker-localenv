...
curl -s -L https://github.com/docker/compose/releases/download/1.24.0-rc3/docker-compose-`uname -s`-`uname -m` > /usr/local/bin/docker-compose && \
...
#wget -q -O /tmp/rancher-compose.tgz https://github.com/rancher/rancher-compose/releases/download/v0.9.0-rc2/rancher-compose-linux-amd64-v0.9.0-rc2.tar.gz && \
